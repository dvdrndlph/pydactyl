...
def compChordTab():  # avoid some typing work: returns mapping constant {ABC chordsyms -> musicXML kind}
    ...
    seventh = zip('7 ma7 Maj7 M7 maj7 mi7 m7 dim7 o7 -7 aug7 +7 m7b5 mi7b5'.split(),
                  [dom, maj + ch7, maj + ch7, maj + ch7, maj + ch7, min + ch7, min + ch7, dim + ch7, dim + ch7,
                   min + ch7, aug + ch7, aug + ch7, hd, hd])
    sixth = zip('6 ma6 M6 mi6 m6'.split(), [maj + ch6, maj + ch6, maj + ch6, min + ch6, min + ch6])
    ninth = zip('9 ma9 M9 maj9 Maj9 mi9 m9'.split(),
                [dom + ch9, maj + ch9, maj + ch9, maj + ch9, maj + ch9, min + ch9, min + ch9])
    elevn = zip('11 ma11 M11 maj11 Maj11 mi11 m11'.split(),
                [dom + ch11, maj + ch11, maj + ch11, maj + ch11, maj + ch11, min + ch11, min + ch11])
